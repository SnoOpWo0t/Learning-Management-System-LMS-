import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-CGL4LIBG.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-PAY54OVR.js";
import {
  getStageColorByHex
} from "./chunk-WYDULDNV.js";
import {
  LimitsModal,
  useReviewWorkflows
} from "./chunk-6E2PRVC4.js";
import {
...
} from "./chunk-XVY4VS3V.js";
import {
  index
} from "./chunk-YY43FE35.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-K3IIQTMX.js";
import {
  useConfig
} from "./chunk-PYMFA7XY.js";
import {
  useTracking
} from "./chunk-6K3RGBKZ.js";
import {
  Drawer,
  abortUpload,
  cancelUpload,
...
} from "./chunk-5AOBKA5Z.js";
import {
  ASSET_TYPES
} from "./chunk-UFEDNOGX.js";
import {
  ASSET_SOURCES,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-FXR6QCE3.js";
import {
  pluginId
} from "./chunk-5QJFIL32.js";
import {
  useDocumentActions
} from "./chunk-56PK73U6.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-EYM3EUXW.js";
import {
  renderAdmin,
  require_baseUniq,
  useDebounce
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-OZJ7EVY6.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
var admin = {
  ...
  register(app) {
    app.addSettingsLink({
      ...
      id: "settings",
      to: "email",
      Component: () => import("./Settings-MQDPMYLB.js").then((mod) => ({
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-BMSPM74H.js");
    case "./translations/es.json":
  ...
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: isBetaMediaLibrary ? () => {
        return import("./App-XGJVXYPW.js").then((mod) => ({
          default: mod.BetaMediaLibrary
        }));
      } : () => {
        return import("./App-YK63IK7T.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    app.addSettingsLink("global", {
      ...
      Component() {
        return import("./SettingsPage-R5PCFJPA.js").then((mod) => ({
          default: mod.ProtectedSettingsPage
        }));
      },
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-7SX2YK5L.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-TYX56FDX.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./ReleasesSettingsPage-WFUZCM7Z.js").then((mod) => ({
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-MNU6GYMO.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./PurchaseContentReleases-QGUXV2ZS.js").then((mod) => ({
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./router-52WOANV4.js").then((mod) => ({
            default: mod.Router
          }));
        }
      });
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-F6B3TENQ.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./purchase-review-workflows-R2FUONAR.js").then((mod) => ({
...
//# sourceMappingURL=chunk-DNOIWKLQ.js.map
